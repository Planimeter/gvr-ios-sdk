...
#import "SteamVRRenderer.h"

#import <GVRKit/GVRKit.h>

@interface SteamVRViewController ()<GVRRendererViewControllerDelegate> {
}
@end

@implementation SteamVRViewController
...
- (void)viewDidLoad {
  ...
  SteamVRRenderer *renderer = [[SteamVRRenderer alloc] init];
...
- (GVRRenderer *)rendererForDisplayMode:(GVRDisplayMode)displayMode {
  ...
  return [[SteamVRRenderer alloc] init];
}
